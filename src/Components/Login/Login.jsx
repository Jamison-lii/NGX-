  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col   items-center">
        <div className="text-4xl pt-10 font-semibold text-[#4169E1]">
          {" "}
          Welcome
        </div>
        ...
        <div onClick={()=>{handleLogin()}} className="bg-[#4169E1] text-white mt-8 px-8 py-2 font-semibold rounded-md transition-normal cursor-pointer ">
          Login
        </div>
      </div>
    </div>
